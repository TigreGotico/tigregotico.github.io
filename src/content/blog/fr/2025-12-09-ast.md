...
description: "Nous publions des modèles expérimentaux de synthèse vocale pour l'asturien (ast) et l'aragonais (an), deux langues romanes minoritaires ne bénéficiant pratiquement d'aucune couverture vocale commerciale. Nous les avons construits avec un pipeline hybride : données filtrées de Common Voice, revocalisation zero-shot et entraînement VITS via phoonnx."
date: 2025-12-09
lang: fr
...
Ni l'asturien ni l'aragonais ne disposent d'un phonémiseur ouvert utilisable, et cela ne changera pas avec une future mise à niveau du modèle. Ces modèles sont entraînés directement sur les graphèmes. Un phonémiseur ajouterait de l'IPA en entrée à l'exécution, forçant la prononciation des noms, des néologismes ou des alternances de code, et améliorerait globalement la cohérence. Si vous connaissez des lexiques existants ou des données de prononciation pour l'une ou l'autre langue, ou si vous souhaitez collaborer à leur création, contactez-nous.
