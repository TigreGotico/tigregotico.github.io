...
Browser-Chrome (Menüs, Tabs und Adressleisten), das Sie nicht selbst gewählt haben, eine Schnittstelle, die für genau
...
**Schicht eins ist ein typisierter Client, der eine Website in eine API verwandelt.**
Das ist genau unsere
[Arbeit an Scraping und API-Reverse-Engineering](/de/blog/2026-04-20-music-database-scrapers):
Er reicht in eine Website hinein, die keine brauchbare öffentliche Schnittstelle hat,
und gibt strukturierte, typisierte Objekte statt brüchigem HTML zurück. Verben,
kein Scraping:
...
**Schicht zwei ist ein OVOS-Plugin, das diese API spricht.** Auf dem Client sitzt ein
...
vorträgt. Es ist bewusst *keine* maßgeschneiderte Skill pro Website, denn dieser Weg
...
Geben Sie einem LLM eine dokumentierte Reihe von Funktionen, etwa `search_albums`,
`get_recommendations` und `stream_url`, und es wird „finde mir etwas wie Naxatras,
...
und jede macht das Web ein wenig durchsuchbarer für die Menschen, die das
