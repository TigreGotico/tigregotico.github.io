...
description: "Estamos a lançar modelos experimentais de texto-para-fala para o asturiano (ast) e o aragonês (an) — duas línguas românicas minoritárias sem praticamente nenhuma cobertura de voz comercial — construídos com uma pipeline híbrida: dados filtrados do Common Voice, revocalização zero-shot e treino VITS através do phoonnx."
date: 2025-12-09
lang: pt
...
Uma coisa que não mudará com uma futura atualização do modelo: nem o asturiano nem o aragonês têm um fonemizador aberto utilizável. Estes modelos são treinados diretamente sobre grafemas. Um fonemizador desbloquearia o input em IPA em tempo de execução (forçando a pronúncia de nomes, neologismos, alternâncias de código) e melhoraria a consistência de forma geral. Se conhecer léxicos existentes ou dados de pronúncia para qualquer uma das línguas, ou quiser colaborar num, entre em contacto.
...
Descarregue os modelos e ouça acima. Se tem dados de pronúncia de asturiano ou aragonês, um léxico de G2P, ou quer contribuir com gravações de voz sob uma licença aberta, entre em contacto — esses recursos melhoram diretamente a próxima iteração.
