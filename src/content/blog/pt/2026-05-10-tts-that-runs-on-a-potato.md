...
**~15,65 milhões de parâmetros.** É a voz inteira: encoder, decoder,
e tudo o resto, num ficheiro de 63 MB. A voz feminina "Dii" do mesmo lançamento chega ao *exato mesmo*
...
Emitem IPA, ARPA, Pinyin, Hangul, Buckwalter: o que
...
preencher lacunas para línguas mal servidas, incluindo basco, mirandês, português europeu e
...
vozes** no total. Um pequeno runtime, e um catálogo enorme, e nada disso a ligar para
casa.
