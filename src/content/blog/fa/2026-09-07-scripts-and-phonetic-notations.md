...
اگر داده‌ی تلفظ را از چندین منبع کنار هم می‌گذارید، یا نیاز دارید رسم‌الخط‌ها را تشخیص دهید و متن را پیش از رسیدن به یک فونمایزر نرمال‌سازی کنید، [با ما تماس بگیرید](/fa/contact) یا ببینید در این حوزه چه چیزهای دیگری در [صفحهٔ خدمات](/fa/services) می‌سازیم.
