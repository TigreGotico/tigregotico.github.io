...
Sitemap-gedreven scrapen loont, omdat u het ontdekken van URL's door te crawlen
(traag, luidruchtig, onvolledig) overslaat en vertrekt vanuit de eigen lijst
...
TLS-impersonerende transport (het bootst de TLS-vingerafdruk van een echte browser na) uit onze
...
Een site die `Crawl-delay: 2` declareert, vertelt u hoe snel ze benaderd wil
worden. Negeer het en u loopt het risico geblokkeerd te worden, of u degradeert
de site voor iedereen. Respecteer het en uw scraper speelt eerlijk.

Een sitemap somt op wat de site geïndexeerd wil zien. Blind links crawlen kan
vijf keer zoveel URL's aanraken om dezelfde inhoud te vinden, dus begin bij de
sitemap wanneer die er is. Het is sneller voor u en lichter voor de server.

Bereik komt vóór code. Sommige sites verbieden scrapen ronduit in robots.txt.
