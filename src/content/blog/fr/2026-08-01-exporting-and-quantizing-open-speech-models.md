...
Si vous avez un modèle de parole qui ne tourne que sur un GPU d'entraînement, ou un appareil qui n'a actuellement aucune prise en charge vocale hors ligne dans sa langue, [contactez-nous](/contact) ou consultez à quoi ressemble ce travail de bout en bout sur [notre page de services](/services).
