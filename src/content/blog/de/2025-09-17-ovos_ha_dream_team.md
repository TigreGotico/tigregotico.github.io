...
## Wyoming-Brücken: OVOS-Sprach-Plugins in Home Assistant

Das Wyoming-Protokoll ist die Standardschnittstelle von HA für externe ASR-, TTS- und Wakeword-Dienste. Wir haben Wyoming-Brücken gebaut, die jedes OVOS-Plugin über dieses Protokoll bereitstellen, sodass HA Zugriff auf jedes Plugin im OVOS-Ökosystem erhält statt nur auf eine kuratierte Auswahl.
...
### Mehrsprachige TTS aus öffentlich finanzierten Sprachprojekten

Zugänglichkeit schließt sprachliche Zugänglichkeit ein. Diese Integration bringt hochwertige, öffentlich finanzierte Stimmen aus Projekten wie **[ILENIA](https://proyectoilenia.es/demostradores-2025/prototipo-ovos/)** einem breiteren Publikum. Home-Assistant-Nutzer erhalten natürlich klingende Stimmen für Sprachen wie Katalanisch und Galicisch, direkt von den Projekten, die sie erstellt haben.
...
* **NosTTS für Galicisch:** Das [`ovos-tts-plugin-nos`](https://github.com/OpenVoiceOS/ovos-tts-plugin-nos) bietet Sprachsynthese auf Galicisch.
...
## OVOS als Konversationsagent für Home Assistant nutzen
...
## OVOS-Geräte mit HiveMind als Home-Assistant-Entitäten sichtbar machen
...
## Home-Assistant-Entitäten von OVOS aus steuern

Der von der Gemeinschaft gepflegte [skill-homeassistant](https://github.com/OscillateLabsLLC/skill-homeassistant) gibt OVOS über die HA-REST-API direkte Kontrolle über Home-Assistant-Entitäten. Installieren Sie ihn auf Ihrem OVOS-Gerät, und Sie können sagen "schalte das Wohnzimmerlicht ein" oder "stelle das Thermostat auf 21 Grad", vollständig lokal und ohne Cloud.

-----

## Was noch nicht rund läuft

Die Wyoming-Brücken und die HiveMind-Integration sind hier die ausgereiftesten Bausteine. Der Weg über den persona-server als Konversationsagent ist neuer. Probieren Sie ihn zuerst aus, wenn Sie sehen wollen, was OVOS und HA zusammen an der Obergrenze leisten können. Fehlerberichte und PRs sind in allen oben verlinkten Repositorys willkommen.
