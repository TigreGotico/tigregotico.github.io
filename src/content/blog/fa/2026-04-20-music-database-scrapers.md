...
description: "گشتی در خانواده‌ای از کلاینت‌های تایپ‌شده پایتون که برای منابع موسیقی نگهداری می‌کنیم — Bandcamp، SoundCloud، SomaFM، TuneIn، iHeartRadio و دانشنامه‌های بزرگ موسیقی — همگی متادیتای رسانه‌ای یکدست و تایپ‌شده را پشت یک واسط تمیز واحد ارائه می‌دهند و بر همان لایه انتقال HTTP سازگار و کم‌حجم سوار هستند."
date: 2026-04-20
updated: 2026-08-01
lang: fa
...
همه اسکرپرها بر **[نشست‌های ترکیب‌پذیر و جایگزینِ مستقیمِ requests](/fa/blog/2026-03-15-beating-bot-walls-with-drop-in-requests-sessions)** ما سوار هستند. کلاینت‌های استریم و رادیو، اسکیمای **[mediavocab](https://github.com/TigreGotico/mediavocab)** را مستقیماً ارائه می‌دهند و هر کلاینت شناسه‌های خارجی canonical را نمایان می‌کند، تا متادیتای موسیقی با **[media-archivist](https://github.com/TigreGotico/media-archivist)** — ایندکسر چندمنبعی و سرور متادیتای حذف‌کننده تکرار ما — یکپارچه شود.
