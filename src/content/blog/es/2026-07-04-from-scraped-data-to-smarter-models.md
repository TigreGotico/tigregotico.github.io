...
Una pregunta justa es *por qué*. Somos una empresa de IA de voz. ¿Por qué
mantenemos scrapers de enciclopedias musicales y directorios de radio?
...
de arquitectura. Viene de datos, y los datos interesantes
rara vez están en un dataset ya preparado. Están repartidos por la web pública, en catálogos que los
...
- **Coincidencia de intención basada en palabras clave**: las listas de entidades
  se convierten en gazetteers (listas de nombres conocidos) que anclan las consultas de medios en OpenVoiceOS.
...
- **Sesgo de modelo de lenguaje**: los LM de n-gramas o de fusión superficial
  (modelos de lenguaje integrados en el paso de decodificación del reconocedor)
...
más de 100.000 pares palabra→IPA de portugués europeo (IPA es el Alfabeto Fonético Internacional, una forma estándar de escribir la pronunciación). Ese dataset:
...
curadas, diccionarios oficiales. También por eso cada dataset que publicamos indica de
...
Las APIs limpias sobre fuentes desordenadas son más que una comodidad de scraping.
