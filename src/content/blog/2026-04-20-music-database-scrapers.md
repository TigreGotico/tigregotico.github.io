...
All scrapers ride our **[anti-bot transport layers](/blog/2026-05-30-beating-bot-walls-with-drop-in-requests-sessions)** and emit the **[mediavocab](https://github.com/OpenVoiceOS/mediavocab)** schema so music metadata integrates seamlessly with **[media-archivist](https://github.com/TigreGotico/media-archivist)**, our cross-source indexer and deduplicating metadata server.
