...
Een terechte vraag is *waarom*. We zijn een spraak-AI-bedrijf; wat doen we met
het onderhouden van scrapers voor muziekencyclopedieën en radiogidsen?
...
- **Zoekwoordgebaseerde intent-matching** — entiteitlijsten worden de gazetteers
  die mediaquery's aarden in OpenVoiceOS.
...
- **Taalmodel-biasing** — n-gram- of shallow-fusion-taalmodellen getraind op
...
meer dan 100.000 Europees-Portugese woord→IPA-paren. Die dataset:
...
samengestelde encyclopedieën, officiële woordenboeken — en daarom vermeldt elke
...
niet zomaar een scraping-gemak — het is hoe je een taalmodel aan feiten verbonden
houdt.
