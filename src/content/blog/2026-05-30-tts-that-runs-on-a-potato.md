...
Let us put a real number on it instead of hand-waving. We pulled a production
...
the lot — in a 63 MB file. The female "Dii" voice from the same release counts
...
through [`onnxruntime`](https://onnxruntime.ai/) on the **CPU** — no CUDA, no GPU, no
...
languages — Basque, Mirandese, European Portuguese and more — rather than waiting for
...
in total. One small runtime, an enormous catalogue, none of it phoning home.
