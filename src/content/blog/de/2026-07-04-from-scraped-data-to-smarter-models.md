...
description: "Saubere, typisierte Daten mit guter Provenienz sind das Rohmaterial jedes Modells, das wir ausliefern. Wie die Kataloge, die unsere Scraper aufbauen, zu Biasing-Vokabularen für ASR, Intent-Klassifikatoren, synthetischen NER-Korpora, G2P-Lexika, TTS-Stimmen werden – und zu ehrlichem Treibstoff für LLMs."
date: 2026-07-04
lang: de
...
Eine berechtigte Frage ist *warum*. Wir sind ein Unternehmen für Sprach-KI; was
tun wir da, Scraper für Musikenzyklopädien und Radioverzeichnisse zu pflegen?
...
- **Schlüsselwortbasiertes Intent-Matching** – Entitätslisten werden zu den
  Gazetteers, die Medienabfragen in OpenVoiceOS verankern.
...
- **Sprachmodell-Biasing** – n-Gramm- oder Shallow-Fusion-LMs, die auf
...
über 100.000 Wort→IPA-Paare des europäischen Portugiesisch. Dieser Datensatz:
...
Enzyklopädien, offizielle Wörterbücher – und deshalb gibt jeder Datensatz, den wir
...
unordentlichen Quellen sind nicht nur eine Scraping-Bequemlichkeit – sie sind die
