...
OVOS identifie la langue parlée dans l'audio avant qu'elle n'atteigne l'étape ASR (reconnaissance vocale automatique), ce qui permet au plugin ASR de transcrire avec précision plutôt que de deviner. J'ai développé plusieurs plugins pour cela :
...
1. La détection de langue de l'audio indique au plugin ASR quelle langue transcrire.
2. La traduction de l'énoncé convertit les énoncés non natifs vers la langue configurée de l'assistant avant la correspondance des skills.
3. La traduction du dialogue traduit la réponse de l'assistant dans la langue de l'utilisateur avant le TTS.
