...
Sete nomes de assistente. Sete datasets. Todo o áudio gerado inteiramente a partir
da framework TTS **[phoonnx](https://github.com/TigreGotico/phoonnx)** usando as
...
As gravações reais exigem meses de recolha, formulários de consentimento para cada
locutor, e ainda assim deixam lacunas de sotaque que não antecipaste. A geração
sintética inverte isso:

- **Reproduzível**: as mesmas definições de geração, as mesmas vozes → o mesmo
  áudio. Rasto de auditoria completo, sem arqueologia de formulários de
  consentimento.
...
Para a deteção de wakeword a propriedade relevante é a distintividade acústica,
não a naturalidade. Os dados sintéticos ajustam-se bem a esse requisito.
