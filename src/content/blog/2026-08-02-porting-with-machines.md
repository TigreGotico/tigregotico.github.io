...
that had no corresponding file. You check, you fix what needs fixing, and the interesting question stays open.

Under an asymmetry that lopsided, you do not need to resolve the legal question
to make the decision. You just take the branch where being wrong is
survivable.
...
questions arrive for the person writing the code and for the person only accepting it.
