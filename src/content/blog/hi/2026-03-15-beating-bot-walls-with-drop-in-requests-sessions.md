---
title: "सुदृढ़ सार्वजनिक-डेटा पहुँच के लिए कंपोज़ेबल, ड्रॉप-इन requests सेशन्स"
description: "सार्वजनिक वेब पेज भरोसेमंद ढंग से पढ़ने के लिए दो कंपोज़ेबल requests.Session सबक्लासेस, हॉट पाथ में हेडलेस ब्राउज़र के बिना: TLS-संगत ट्रांसपोर्ट, JS चैलेंज के लिए एक FlareSolverr प्रॉक्सी, एक Wayback Machine फ़ॉलबैक, और IP-विविधीकृत अनुरोध — unblock_requests और anon_requests।"
date: 2026-03-15
lang: hi
...
कभी डेटा होती है; समस्या यह है कि बहुत-सा बॉट-डिटेक्शन इन्फ़्रास्ट्रक्चर स्क्रिप्टेड
हमलों के विरुद्ध ट्यून किया गया था और किसी भी शिष्ट, गैर-ब्राउज़र क्लाइंट को भी एक वैसा
ही समझ बैठता है। यह दो अलग-अलग धुरियों पर होता है:

- **"तुम क्या हो?"** — Cloudflare और उसके जैसे टूल्स अनुरोधों को इसलिए फ़्लैग करते हैं
  कि आप *क्या* माँग रहे हैं इसलिए नहीं, बल्कि इसलिए कि तार पर आप *कैसे* दिखते हैं:
  आपका TLS हैंडशेक, आपका JA3 फ़िंगरप्रिंट, क्या आप कोई JavaScript चैलेंज चला सकते हैं।
  एक सादा `requests` हैंडशेक किसी ब्राउज़र जैसा बिलकुल नहीं दिखता, इसलिए वह उन जाँचों
  में पकड़ा जाता है जो स्क्रिप्टेड दुरुपयोग को लक्षित करती हैं, भले ही ट्रैफ़िक खुद
  हानिरहित हो।
- **"तुम कौन हो?"** — IP प्रतिष्ठा और रेट लिमिट्स आपके फ़िंगरप्रिंट की परवाह ही नहीं
  करतीं; वे बस गिनती हैं कि एक ही पते से कितने अनुरोध आते हैं, जो एक अकेले शिष्ट
  क्लाइंट को उतनी ही आसानी से दंडित कर सकता है जितना किसी दुरुपयोग करने वाले को।

दोनों धुरियाँ आपस में स्वतंत्र (ऑर्थोगोनल) हैं, इसलिए हम उनका जवाब दो छोटी लाइब्रेरियों से
...
**दायरा, स्पष्ट रूप से कहें तो:** ये ट्रांसपोर्ट केवल सार्वजनिक, गैर-प्रमाणीकृत पेजों के
लिए हैं। ये `robots.txt` और किसी भी घोषित crawl-delay का सम्मान करते हैं — देखें हमारी
**[robots.txt और sitemaps वाली पोस्ट](/hi/blog/2026-03-01-robot-txt-sitemaps-ethical-web-scraping)**
यह देखने के लिए कि स्क्रैपर लिखने से पहले हम यह कैसे जाँचते हैं — और इनके ऊपर बना हर
क्लाइंट कम अनुरोध मात्रा तक सीमित रखा जाता है, ताकि किसी लक्ष्य साइट को हमारी ओर से कभी
सार्थक लोड न दिखे। यह बाद में जोड़ा गया कोई अस्वीकरण नहीं है; यह इस पर एक वास्तविक
इंजीनियरिंग बंधन है कि ये सेशन कैसे इस्तेमाल होते हैं, क्योंकि एक सुदृढ़ क्लाइंट जो साथ
में असावधान भी हो, अपने ही उद्देश्य को विफल कर देता है।
...
`unblock_requests` एक सादे Python क्लाइंट को **ब्राउज़रों के लिए ट्यून की गई बॉट-डिटेक्शन
जाँचों** के साथ इंटरऑपरेबल बनाती है। आप `mode=` kwarg (या
`UNBLOCK_REQUESTS_TRANSPORT` env वेरिएबल — स्पष्ट kwargs हमेशा जीतते हैं) से एक ट्रांसपोर्ट
चुनते हैं। मुख्य चार:

| Mode | यह क्या करता है |
|---|---|
| `curl_cffi` *(डिफ़ॉल्ट)* | `curl_cffi` के ज़रिए Chrome TLS/JA3 इम्पर्सनेशन। बिना किसी अतिरिक्त इन्फ़्रा के अधिकांश नेटवर्कों पर एक ब्राउज़र-जैसा हैंडशेक बनकर गुज़र जाता है। |
...
इससे स्वतंत्र समस्या है **IP प्रतिष्ठा**। बिलकुल ब्राउज़र-जैसा हैंडशेक भी रेट-लिमिट हो
सकता है अगर हर अनुरोध एक ही पते से आए — मात्रा-आधारित ह्यूरिस्टिक्स फ़िंगरप्रिंट को नहीं,
पते को देखती हैं। `anon_requests` `RotatingProxySession` (स्क्रेप किए गए सार्वजनिक प्रॉक्सी,
वैकल्पिक सत्यापन, SOCKS5/HTTP) और `RotatingTorSession` (घूमते Tor सर्किट) के साथ पतों में
लोड फैलाती है, ताकि एक कम-मात्रा वाला क्लाइंट कभी उस क्लाइंट के लिए न समझा जाए जो किसी
साइट पर एक ही IP से हथौड़े बरसा रहा हो। हर अनुरोध एक नए एग्ज़िट से बाहर जाता है, और कनेक्शन
विफलता पर मरे हुए प्रॉक्सी हटा दिए जाते हैं।
...
## संयोजन: वितरित लोड **और** एक संगत हैंडशेक, दोनों एक साथ
...
solve अनुरोध के `proxy` फ़ील्ड के ज़रिए अपने हेडलेस ब्राउज़र को चलाता है। तो पूरा अनुरोध —
हैंडशेक, चैलेंज सॉल्व, और एग्ज़िट IP — शुरू से अंत तक सुसंगत रहता है, जो कि उस क्लाइंट के
लिए बस सही व्यवहार है जो एक से ज़्यादा विज़िटर जैसा दिखने की कोशिश नहीं कर रहा।
