...
**~15,65 Millionen Parameter.** Das ist die gesamte Stimme — Encoder, Decoder, das
Ganze — in einer 63-MB-Datei. Die weibliche "Dii"-Stimme aus derselben Veröffentlichung
...
und laufen über [`onnxruntime`](https://onnxruntime.ai/) auf der **CPU** — kein CUDA,
keine GPU, kein Treiber-Roulette. `onnxruntime` ist eine kompakte, portable
...
Japanisch und KoG2P für Koreanisch. Sie geben IPA, ARPA, Pinyin, Hangul, Buckwalter aus
— was auch immer die Sprache braucht. Es gibt sogar ein modellbasiertes mehrsprachiges
...
unterversorgte Sprachen gefüllt — Baskisch, Mirandesisch, europäisches Portugiesisch und
...
Sprachen und Stimmen** insgesamt. Ein kleines Runtime, ein riesiger Katalog, und nichts
