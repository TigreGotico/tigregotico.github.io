...
POS les étiquette de manière identique, puisqu'il n'y a aucun signal grammatical pour les
...
aval, un BiLSTM par exemple, voie chaque sens dans les deux moitiés. Il est publié sur
...
bibliothèque [`bifonia`](https://github.com/TigreGotico/bifonia), est léger et
**entièrement sans dépendances**. Il atteint **≈94 %**, et atteint **100 %** sur
le cas `sede`/*soif* sur lequel les étiqueteurs POS obtiennent **0 %**.

Le chiffre compte moins que la raison derrière lui : un composant petit, rapide
...
modèle géant. La même approche se transpose proprement à une langue apparentée
