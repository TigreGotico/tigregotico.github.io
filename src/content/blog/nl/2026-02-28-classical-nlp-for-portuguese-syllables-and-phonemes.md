...
Dat is hetzelfde instinct achter `pt-PT`, `pt-BR`, `pt-AO`, `pt-MZ` en `pt-TL` in TugaPhone: behandel elke Lusofone variëteit op zijn eigen voorwaarden, met zijn eigen regels, en niet als een afwijking van één canoniek accent. De data is declaratief en de logica is dun en pluggable, dus je kunt de regels lezen, hun bronnen citeren en de uitvoer vertrouwen.
