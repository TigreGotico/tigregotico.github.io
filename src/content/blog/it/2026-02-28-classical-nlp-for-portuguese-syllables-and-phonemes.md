...
Non tutti i problemi linguistici richiedono un miliardo di parametri. Gran parte dell'elaborazione del testo in portoghese è governata da regole che i linguisti hanno messo per iscritto molto prima che qualcuno addestrasse una rete neurale — regole su dove si dividono le sillabe, dove cade l'accento e come una data ortografia si mappa in un suono. Quando quelle regole sono esplicite, lo strumento giusto è una libreria piccola, deterministica e completamente offline che si può leggere, verificare ed eseguire ovunque. È questa la filosofia dietro il nostro stack classico di NLP per il portoghese: [silabificador](https://github.com/TigreGotico/silabificador) per la sillabazione e [TugaPhone](https://github.com/TigreGotico/tugaphone) per il grafema-in-fonema (G2P).
...
Dietro le quinte, TugaPhone è un **ibrido** di due tecniche classiche. Prima consulta un lessico fonetico curato (lo stesso Portuguese Phonetic Lexicon di cui sopra) per le parole note; per tutto ciò che non è nel lessico — nomi, neologismi, prestiti stranieri — ricorre a un motore di G2P basato su regole. La pipeline è esplicita in ogni fase: normalizzazione del testo, etichettatura morfosintattica opzionale, consultazione del lessico, ricorso alle regole e, infine, trasformazioni specifiche del dialetto.
...
Questo stack di fonetica portoghese si basa sul nostro **[lavoro di grafema-in-IPA per oltre 350 lingue](/it/blog/2026-01-15-grapheme-to-ipa-for-350-languages)**, formando la spina dorsale fonetica del **[TTS che gira su una patata](/it/blog/2026-05-10-tts-that-runs-on-a-potato)** e delle **[voci multilingue Miro & Dii](/it/blog/2026-06-15-two-voices-every-language-miro-and-dii)**.
