...
slechter dan voorheen? "Het klinkt beter voor mij" schaalt niet. Het
...
spraakkwaliteitsmetriek precies omdat hij de vraag stelt die ertoe doet —
...
beoordelen. Gebruik deze familie wanneer er geen ground truth is om mee te
...
natuurlijk en schoon klinkt maar de verkeerde woorden zegt. Een
no-reference MOS-voorspeller beoordeelt natuurlijkheid, niet juistheid —
...
wanneer de kwaliteit beter is; MCD, toonhoogtefout en spectrale afstand
gaan omlaag. Ze door elkaar halen bij het lezen van een tabel is een
...
licht verwerkte opname zou scoren. Een SI-SDR van ongeveer −27 dB
...
verandering, niet alleen toegevoegde ruis. Een MCD van 10.46 dB is hoog;
gepubliceerde TTS-systemen die duidelijk synthetisch klinken maar toch
...
als een heel ontbrekend token; CER en WER beantwoorden verschillende
...
opnamecondities. Een voorspeller die vooral getraind is op Engelse
...
echt moet beluisteren. Het is geen vervanging voor een echt luisterpanel
...
niet getraind is om te beoordelen. Meerdere voorspellers samen
rapporteren, en onenigheid tussen hen behandelen als een aanleiding om te
luisteren in plaats van ruis om weg te middelen, is de praktische
verzachting.
