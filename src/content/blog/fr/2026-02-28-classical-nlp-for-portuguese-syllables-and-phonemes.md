...
C'est le même instinct qui sous-tend `pt-PT`, `pt-BR`, `pt-AO`, `pt-MZ` et `pt-TL` dans TugaPhone : traiter chaque variété lusophone sur ses propres termes, avec ses propres règles, et non comme une déviation d'un unique accent canonique. Les données sont déclaratives et la logique est mince et enfichable, si bien que vous pouvez lire les règles, citer leurs sources et faire confiance au résultat.
