...
1. **Ambiguidade.** As mesmas letras podem mapear para sons diferentes consoante o significado, a gramática, ou a pura irregularidade ("read" acima; o inglês tem muitos casos destes).
...
## Os dialetos têm regras próprias, não são um pormenor secundário
