...
Een model dat alleen op Engels is getraind, maakt deze gevallen overal elders fout. Parallelle, gelabelde data over de zeven talen leveren het cross-linguïstische signaal dat classificatoren per taal nodig hebben — en dezelfde generatiepipeline breidt zich uit naar verdere talen naarmate deze worden toegevoegd.
